...
from browser_mcp.contracts import Down,Upload
...
def test_download_transport_is_runtime_selected():
 assert set(Down.model_fields)=={"selector","max_bytes","media_type"}
